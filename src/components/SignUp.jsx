    ...
    return (
        <div className="signup-container bg-auth min-h-screen flex items-center justify-center">
            ...
            <div className="flex flex-col md:flex-row bg-white rounded-xl shadow-lg max-w-4xl w-full">
                ...
                {/* Right Side - Form*/}
                <div className="right-signup w-full md:w-1/2 p-8 ">
                    <h2 className="text-black font-bold flex justify-start py-2 mb-5 text-4xl">Sign Up</h2>

                    {/* Add form here later */}
                    <form action="SignIn.jsx" onSubmit={handleSubmit} noValidate>
